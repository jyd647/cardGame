...
public class Randomizer {
	...
	* 
	* @paramprobabilityThe probability that the method returns true, a
	value between 0 to 1 inclusive. 
	...
	* @param nThe maximum value for the range.
	...
	* @param minThe minimum integer value of the range, inclusive.
	* @param maxThe maximum integer value in the range, inclusive.
